...
{
	$sql = "SELECT pj_jokes.joke_id, pj_jokes.content, pj_user.user_id, pj_user.nick_name, pj_user.avatar FROM pj_jokes LEFT JOIN pj_user ON pj_jokes.user_id = pj_user.user_id order by pj_jokes.create_time desc";
